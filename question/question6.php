...
<form method="post" action="q1_copy.php"> 
  <table> 
  <th>
  <td width=100>< US$ 4,000 </td>
  <td width=100>US$ 4,000 - US$ 6,000 </td>
  <td width=100>>= US$ 6,000 is fine </td>
  </th>
<?php 
   	$i=1;
	while($row = mysql_fetch_array($res))
  	{
  	 echo "<tr> <td width=500>".$i.". ".$row['What is your preferred Living Cost?']."</td>";
