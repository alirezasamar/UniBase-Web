...
<form method="post" action="q1_copy.php"> 
  <table> 
  <th>
  <td width=100>Europe</td>
  <td width=100>North America</td>
  <td width=100>Asian</td>
  <td width=100>Anywhere is fine</td>
...
<?php 
	...
	while($row = mysql_fetch_array($res))
  	{
  	 echo "<tr> <td width=500>".$i.". ".$row['Do you have any country region where you want to study in? If yes, where is it?']."</td>";
	 ...
	 echo '<td width=100> <input type="radio" name="score'.$i.'"  value=3 '; if (score."$i"==2) {echo ' selected ';}; echo '> </td>';
